        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="card" style="width: 18rem;">
                    <img src="https://driverjs.com/og-img.png" class="card-img-top" alt="preview">
                    <div class="card-body">
                        <div class="content is-clipped">
                            <div class="mb-2"><strong>Driver.js</strong></div>
                            <div class="mb-2">A light-weight, no-dependency, vanilla JavaScript library to drive user's focus across the page.</div>
